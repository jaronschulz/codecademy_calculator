  ...
  describe('.absoluteValue', () => {
    ...
    describe('.exponential',() => {
      it('returns the result of a base raised to a power', () => {
        ...
        const result = Calculate.exponential(base, exponent);
    ...
    describe('.max', () => {
      it('returns the maximum number of 5 in an array', () => {
        const inputArray = [2,1,5];
        const expected = 5;
      ...
      it('returns the maximum number of 7 in an array', () => {
        const inputArray = [2,1,7];
        const expected = 7;
      ...
      it('throws an Error when the array is empty', () => {
        ...
        const exercise = () => Calculate.max(inputArray);
    ...
    describe('.min', () => {
      ...
      it('throws an Error when the array is empty', () => {
        ...
        const exercise = () => Calculate.min(inputArray);
    ...
    describe('.average', () => {
      it('returns the average value of an array', () => {
        ...
        const exercise = Calculate.average(inputArray);
